window.onload = function() {
    ...
    var levels = [
        [
            ['GIVE', 'GIVEN'],
            ['GIEN', 'VEIN', 'VINE', 'GEN', 'GIE', 'GIN', 'VEG', 'VIE']
        ],
        [
            ['ICE', 'VICE', 'VOICE'],
            ['COVE', 'ECO', 'VIE']
        ...
        [
            ['AM', 'AS', 'ALL', 'MALL', 'SMALL'],
            ['MALLS', 'ALLS', 'ALMS', 'LAMS', 'SALL', 'SLAM', 'LAM']
        ],
        [
            ['SEE', 'SEEN', 'SENSE'],
            ['ESES', 'NESS', 'SEES', 'SENE', 'SEN']
        ],
        [
            ['HIM', 'HIT', 'MIGHT'],
            ['GIT', 'TIM']
        ...
        [
            ['AT', 'TO', 'LOT', 'TOTAL'],
            ['ALTO', 'TALT', 'OAT', 'TAO', 'TAT', 'TOT']
        ],
        [
            ['OR', 'FOR', 'FOOL', 'ROOF', 'FLOOR'],
            ['OF', 'LOOF', 'ROLF', 'FRO', 'LOO', 'ROO']
        ],
        [
            ['AM', 'ARM', 'MAD', 'DRAMA'],
            ['DAMAR', 'DRAM', 'MAAR', 'AMA', 'DAM', 'MAR', 'RAD', 'RAM']
        ],
        [
            ['IN', 'IT', 'NUT', 'UNIT', 'UNTIL'],
            ['UNLIT', 'LINT', 'LITU', 'LUNT', 'LIT', 'NIL', 'TIL', 'TIN', 'TUN']
        ],
        [
            ['DIE', 'DIG', 'DUE', 'GUIDE'],
            ['DUG', 'GIE']
        ...
        [
            ['AGE', 'ALL', 'LEG', 'LEGAL'],
            ['EGAL', 'GALE', 'GALL', 'LEAL', 'ALE', 'GAL', 'GEL', 'LAG']
        ],
        [
            ['US', 'DUST', 'DUTY', 'STUDY'],
            ['DUSTY', 'STUD', 'STY', 'USD']
        ...
        [
            ['SEE', 'KNEE', 'SEEK', 'KNEES'],
            ['KEENS', 'SKEEN', 'SKENE', 'KEEN', 'SEEN', 'SENE', 'SKEE', 'EEK', 'EKE', 'SEN']
        ],
        [
            ['HE', 'WE', 'HER', 'HERE', 'WHERE'],
            ['HEWER', 'EWER', 'WEER', 'WERE', 'WHEE', 'ERE', 'EWE', 'HEW', 'REE', 'WEE']
        ],
        [
            ['LET', 'SET', 'YES', 'YET', 'STYLE'],
            ['LEST', 'LETS', 'STEY', 'STYE', 'TYES', 'LES', 'LEY', 'LYE', 'SLY', 'STY']
        ],
        [
            ['OK', 'LOCK', 'CLOCK'],
            ['COL']
        ...
        [
            ['HE', 'SO', 'SHE', 'SHOE', 'SHOES'],
            ['HOSES', 'HOES', 'HOSE', 'SHES', 'HOE']
        ],
        [
        ...
        [
            ['EYE', 'EVER', 'VERY', 'EVERY'],
            ['VEERY', 'VEER', 'ERE', 'EVE', 'REE', 'REV', 'RYE', 'YER']
        ],
        [
            ['TO', 'OUT', 'TOE', 'QUOTE'],
            []
        ...
        [
            ['IN', 'BIG', 'RING', 'BRING'],
            ['BRIG', 'GIRN', 'GRIN', 'BIN', 'GIN', 'NIB', 'RIB', 'RIG']
        ],
        [
            ['CAP', 'PACE', 'PEACE'],
            ['CAPE', 'CEPE', 'ACE', 'APE', 'PEA', 'PEE']
        ],
        [
            ['IT', 'HIT', 'DIRT', 'THIRD'],
            ['THIR', 'DIT', 'HID', 'RID', 'TRI']
        ],
        [
            ['SEE', 'ELSE', 'PEEL', 'SLEEP'],
            ['PEELS', 'EELS', 'PEES', 'SEEP', 'EEL', 'LES', 'PEE']
        ],
        [
            ['AT', 'IT', 'VIA', 'TAIL', 'VITAL'],
            ['TALI', 'VAIL', 'VIAL', 'VITA', 'AIL', 'AIT', 'LAV', 'LIT', 'TIL', 'VAT']
        ],
        [
            ['COW', 'ROW', 'WORD', 'CROWD'],
            ['CORD', 'CROW', 'COD', 'DOW', 'ORC', 'ROC', 'ROD']
        ],
        [
            ['DOVE', 'MODE', 'MOVE', 'MOVED'],
            ['DEMO', 'DOME', 'DEV', 'DOE', 'MED', 'ODE']
        ],
        [
            ['AM', 'OR', 'ARM', 'ORAL', 'MORAL'],
            ['MOLAR', 'LOAM', 'MARL', 'MORA', 'ROAM', 'LAM', 'MAR', 'MOL', 'OAR', 'ORA', 'RAM']
        ],
        [
            ['DIE', 'RED', 'DIVE', 'RIDE', 'DRIVE'],
            ['DIVER', 'RIVED', 'DIRE', 'IRED', 'RIVE', 'VIED', 'DEV', 'IRE', 'REI', 'REV', 'RID', 'VIE']
        ],
        [
            ['AIR', 'CAR', 'HAIR', 'RICH', 'CHAIR'],
            ['ARCH', 'CHAR', 'RICA', 'ARC']
        ],
        [
            ['RUN', 'SUN', 'USE', 'SURE', 'NURSE'],
            ['SUE', 'RUNES', 'ERNS', 'RUES', 'RUNE', 'RUNS', 'RUSE', 'URNS', 'USER', 'RES', 'RUE', 'SEN', 'SER', 'SUR', 'URN']
        ],
        [
            ['COT', 'COST', 'COSTS'],
            ['SCOTS', 'COTS', 'SCOT', 'SOTS', 'TOSS']
        ],
        [
            ['EVE', 'EVER', 'VEER', 'SERVE'],
            ['SEVER', 'VEERS', 'VERSE', 'EVES', 'REVS', 'SEER', 'SERE', 'ERE', 'REE', 'RES', 'REV', 'SEE', 'SER']
        ],
        [
            ['SEE', 'SEW', 'SEEK', 'WEEK', 'WEEKS'],
            ['EWES', 'SKEE', 'SKEW', 'EEK', 'EKE', 'EWE', 'WEE']
        ],
        [
            ['BOT', 'BUD', 'BUT', 'OUT', 'DOUBT'],
            ['BOUT', 'DOT', 'DUB', 'DUO', 'OUD', 'TOD', 'TUB', 'UDO']
        ],
        [
            ['IN', 'GIN', 'GRIN', 'RING', 'REIGN'],
            ['NIGER', 'GIEN', 'GIRE', 'GIRN', 'REIN', 'GEN', 'GIE', 'IRE', 'REG', 'REI', 'RIG']
        ],
        [
            ['IT', 'NUT', 'TINY', 'UNIT', 'UNITY'],
            ['IN', 'TIN', 'TUN']
        ],
        [
            ['IN', 'IS', 'SIGN', 'SING', 'SIGNS'],
            ['SINGS', 'GINS', 'SINS', 'GIN', 'INS', 'SIN']
        ],
        [
            ['OLD', 'FOLD', 'FOOD', 'FOOL', 'FLOOD'],
            ['LOOF', 'LOO']
        ],
        [
            ['FOE', 'CORE', 'FORE', 'FORCE'],
            ['FOR', 'CERO', 'CORF', 'FROE', 'ECO', 'FER', 'FRO', 'ORC', 'ORE', 'REC', 'REF', 'ROC', 'ROE']
        ],
        [
            ['FAME', 'LEAF', 'MALE', 'MEAL', 'FLAME'],
            ['FLEAM', 'ALEF', 'ALME', 'FEAL', 'FLAM', 'FLEA', 'LAME', 'ALE', 'ELM', 'ELF', 'FEM', 'LAM', 'LEF', 'MAE']
        ],
        [
            ['CAN', 'INCH', 'CHAIN', 'CHINA'],
            ['CAIN', 'CHAN', 'CHIN', 'INCA', 'ANI', 'HIN', 'NAH']
        ],
        [
            ['SET', 'SHE', 'THE', 'CHEST'],
            ['ETCH', 'ETHS', 'HEST', 'HETS', 'SECT', 'TECH', 'ETC', 'HET', 'SEC']
        ],
    ...
    var points = [
        [Math.round(ll + w / 2), Math.round(ltp + ct + cw / 8)],
        [Math.round(ll + cl + cw / 8), Math.round(ltp + ct + ch * 41.5 / 100)],
        [Math.round(ll + w - (cl + cw * 25 / 200)), Math.round(ltp + ct + ch * 41.5 / 100)],
        [Math.round(ll + cl + cw / 4), Math.round(ltp + ct + ch * 87.5 / 100)],
        [Math.round(ll + w - (cl + cw / 4)), Math.round(ltp + ct + ch * 87.5 / 100)]
    ];
    var linePoints = [];
    var started = true;
